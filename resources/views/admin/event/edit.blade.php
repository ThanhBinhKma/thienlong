        ...
        <div class="col-md-3 right-sidebar">
          ...
          <div class="widget meta-boxes">
            ...
            <div class="widget-body">
              <div class="image-box">
                @if ($event->avatar)
                  <input id="thumbnail" type="hidden" name="thumbnail" value="{{$event->avatar }}" class="image-data">
                  <div class="preview-image-wrapper ">
                    <img id="holder" class="preview_image" src="{{ $event->avatar }}" type="text" name="filepath" alt="preview image">
